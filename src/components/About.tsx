...
export function About() {
  return (
    <section id="about" className="py-16 px-6 sm:px-12 lg:px-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-300 text-base sm:text-lg mb-8">
                I’m Abdullah Shuaib, a skilled UI/UX Designer with over a year
                of experience and a background in graphic design. I specialize
                in WordPress design and have strong expertise in JavaScript,
                CSS, and HTML, enabling me to deliver seamless and engaging
